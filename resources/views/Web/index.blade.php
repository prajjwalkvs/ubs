...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="{{asset('public/assets/img/favicons/apple-icon-57x57.png')}}" />
    <link rel="apple-touch-icon" sizes="60x60" href="{{asset('public/assets/img/favicons/apple-icon-60x60.png')}}" />
    <link rel="apple-touch-icon" sizes="72x72" href="{{asset('public/assets/img/favicons/apple-icon-72x72.png')}}" />
    <link rel="apple-touch-icon" sizes="76x76" href="{{asset('public/assets/img/favicons/apple-icon-76x76.png')}}" />
    <link rel="apple-touch-icon" sizes="114x114" href="{{asset('public/assets/img/favicons/apple-icon-114x114.png')}}" />
    <link rel="apple-touch-icon" sizes="120x120" href="{{asset('public/assets/img/favicons/apple-icon-120x120.png')}}" />
    <link rel="apple-touch-icon" sizes="144x144" href="{{asset('public/assets/img/favicons/apple-icon-144x144.png')}}" />
    <link rel="apple-touch-icon" sizes="152x152" href="{{asset('public/assets/img/favicons/apple-icon-152x152.png')}}" />
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('public/assets/img/favicons/apple-icon-180x180.png')}}" />
    <link rel="icon" type="image/png" sizes="192x192" href="{{asset('public/assets/img/favicons/android-icon-192x192.png')}}" />
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('public/assets/img/favicons/favicon-32x32.png')}}" />
    <link rel="icon" type="image/png" sizes="96x96" href="{{asset('public/assets/img/favicons/favicon-96x96.png')}}" />
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('public/assets/img/favicons/favicon-16x16.png')}}" />
    <link rel="manifest" href="{{asset('public/assets/img/favicons/manifest.html')}}" />
...
<body>
                ...
                <div class="widget_shopping_cart_content">
                    <ul class="woocommerce-mini-cart cart_list product_list_widget">
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            ...
                            <a href="#"><img src="{{asset('public/assets/img/product/product_thumb_1_1.jpg')}}" alt="Cart Image" />Plastic
                                Book Bags</a>
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="#"><img src="{{asset('public/assets/img/product/product_thumb_1_2.jpg')}}" alt="Cart Image" />The Genie
                                Mind</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount"><span
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="#"><img src="{{asset('public/assets/img/product/product_thumb_1_3.jpg')}}" alt="Cart Image" />The
                                Energy Book</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount"><span
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="#"><img src="{{asset('public/assets/img/product/product_thumb_1_4.jpg')}}" alt="Cart Image" />Pencil
                                Bag</a>
                            <span class="quantity">1 ×
                                <span class="woocommerce-Price-amount amount"><span
                        ...
                        <li class="woocommerce-mini-cart-item mini_cart_item">
                            <a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
                            <a href="#"><img src="{{asset('public/assets/img/product/product_thumb_1_5.jpg')}}"
    ...
    <div class="th-menu-wrapper">
        <div class="th-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="index.html"><img src="{{asset('public/assets/img/logo.svg')}}" alt="Edura" /></a>
            </div>
                        ...
                        <ul class="sub-menu">
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="home-12.html">Online Instructor <span class="new-label">New</span></a>
                                    </li>
                                    <li>
                                        <a href="home-13.html">Skill Development <span class="new-label">New</span></a>
                                    </li>
                                    <li>
                ...
                <div class="row justify-content-center justify-content-lg-between align-items-center gy-2">
                    <div class="col-auto d-none d-lg-block">
                        <div class="header-links">
                            <ul>
                                <li>
                                    <i class="far fa-phone"></i><a href="tel:+11156456825">+111 (564) 568 25</a>
                                </li>
                                <li class="d-none d-xl-inline-block">
                                    <i class="far fa-envelope"></i><a href="mailto:info@Edura.com">info@edura.com</a>
                                </li>
                                                ...
                                                <ul class="sub-menu">
                                                    <li class="menu-item-has-children">
                                                        ...
                                                        <ul class="sub-menu">
                                                            ...
                                                            <li>
                                                                <a href="home-5.html">Home Academy
                                                                    <span class="new-label">New</span></a>
                                                            </li>
                                                            <li>
                                                                <a href="home-6.html">Home Online Training
                                                            ...
                                                            <li>
                                                                <a href="home-9.html">Home Kindergarten
                                                                    <span class="new-label">New</span></a>
                                                            </li>
                                                            <li>
                                                                <a href="home-10.html">Home University
                                                                    <span class="new-label">New</span></a>
                                                            </li>
                                                            <li>
                                                                <a href="home-11.html">Online Education
                                                                    <span class="new-label">New</span></a>
                                                            </li>
                                                            <li>
                                                                <a href="home-12.html">Online Instructor
                                                                    <span class="new-label">New</span></a>
                                                            </li>
                                                            <li>
                                                                <a href="home-13.html">Skill Development
                                                                    <span class="new-label">New</span></a>
                                                            </li>
                                                            <li>
                                                                <a href="home-14.html">Home Trainer
                                                                    <span class="new-label">New</span></a>
                                                            </li>
                                                            <li>
                                                                <a href="home-15.html">Home Admission
                                                                    <span class="new-label">New</span></a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li class="menu-item-has-children">
                                                        ...
                                                        <ul class="sub-menu">
                                                            ...
                                                            <li>
                                                                <a href="home2-onepage.html">Online Education
                                                                    Onepage</a>
                                                            </li>
                                                            <li>
                                                                <a href="home3-onepage.html">University Admission
                                                                    Onepage</a>
                                                            </li>
                                                            <li>
                                                                <a href="home4-onepage.html">Digital Education
                                                                    Onepage</a>
                                                            </li>
                                                            <li>
                                                                <a href="home5-onepage.html">Academy Onepage
                                                                    <span class="new-label">New</span></a>
                                                            </li>
                                                            <li>
                                                                <a href="home6-onepage.html">Online Training Onepage
                                                            ...
                                                            <li>
                                                                <a href="home14-onepage.html">Trainer Onepage
                                                                    <span class="new-label">New</span></a>
                                                            </li>
                                                            <li>
                                                                <a href="home15-onepage.html">Admission Onepage
                                                                    <span class="new-label">New</span></a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                ...
                                <div class="col-auto d-none d-xl-block">
                                    <div class="header-button">
                                        ...
                                        <a href="wishlist.html" class="icon-btn"><i class="far fa-heart"></i>
                                            <span class="badge">3</span> </a><button type="button"
        ...
        <div class="hero-slider-1 th-carousel" data-fade="true" data-slide-show="1" data-md-slide-show="1"
            ...
            <div class="th-hero-slide">
                <div class="th-hero-bg" data-overlay="title" data-opacity="8"
                    data-bg-src="{{asset('public/assets/img/hero/hero_bg_1_1.jpg')}}"></div>
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-6">
                            <div class="hero-style1">
                                <span class="hero-subtitle" data-ani="slideinleft" data-ani-delay="0.1s"><span>35%
                                        OFF</span> LEARN FROM TODAY</span>
                                ...
                                <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.6s">
                                    Education can be thought of as the transmission of the
                                    values and accumulated knowledge of a society. In this
                                    sense, it is equivalent.
                                </p>
                                <div class="btn-group" data-ani="slideinleft" data-ani-delay="0.8s">
                                    <a href="contact.html" class="th-btn style3">Get Started<i
                        ...
                        <div class="col-md-6 text-lg-end text-center">
                            <div class="hero-img1">
                                <img src="{{asset('public/assets/img/hero/hero_thumb_1_1.jpg')}}" alt="hero" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="hero-shape shape1">
                    <img src="{{asset('public/assets/img/hero/shape_1_1.png')}}" alt="shape" />
                </div>
                <div class="hero-shape shape2">
                    <img src="{{asset('public/assets/img/hero/shape_1_2.png')}}" alt="shape" />
                </div>
                <div class="hero-shape shape3"></div>
                <div class="hero-shape shape4 shape-mockup jump-reverse" data-right="3%" data-bottom="7%">
                    <img src="{{asset('public/assets/img/hero/shape_1_3.png')}}" alt="shape" />
                </div>
                <div class="hero-shape shape5 shape-mockup jump-reverse" data-left="0" data-bottom="0">
                    <img src="{{asset('public/assets/img/hero/shape_1_4.png')}}" alt="shape" />
                </div>
            </div>
            <div class="th-hero-slide">
                <div class="th-hero-bg" data-overlay="title" data-opacity="8"
                    data-bg-src="{{asset('public/assets/img/hero/hero_bg_1_2.jpg')}}"></div>
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-6">
                            <div class="hero-style1">
                                ...
                                <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.6s">
                                    Education can be thought of as the transmission of a
                                    societys values and accumulated knowledge. In this sense, it
                                    is equivalent.
                                </p>
                                <div class="btn-group" data-ani="slideinleft" data-ani-delay="0.8s">
                                    <a href="contact.html" class="th-btn style3">Get Started<i
                        ...
                        <div class="col-md-6 text-lg-end text-center">
                            <div class="hero-img1">
                                <img src="{{asset('public/assets/img/hero/hero_thumb_1_2.jpg')}}" alt="hero" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="th-hero-slide">
                <div class="th-hero-bg" data-overlay="title" data-opacity="8"
                    data-bg-src="{{asset('public/assets/img/hero/hero_bg_1_3.jpg')}}"></div>
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-6">
                            <div class="hero-style1">
                        ...
                        <div class="col-md-6 text-lg-end text-center">
                            <div class="hero-img1">
                                <img src="{{asset('public/assets/img/hero/hero_thumb_1_3.jpg')}}" alt="hero" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="category-sec-wrap">
                <div class="shape-mockup category-shape-arrow d-xl-block d-none">
                    <img src="{{asset('public/assets/img/normal/category-arrow.svg')}}" alt="img" />
                </div>
                <div class="row">
                    <div class="col-xl-4">
                    ...
                    <div class="col-xl-8">
                        <div class="row slider-shadow th-carousel category-slider" data-slide-show="4"
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="category-card">
                                    <div class="category-card_icon">
                                        <img src="{{asset('public/assets/img/icon/cat-1_1.svg')}}" alt="image" />
                                    </div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="category-card">
                                    <div class="category-card_icon">
                                        <img src="{{asset('public/assets/img/icon/cat-1_2.svg')}}" alt="image" />
                                    </div>
                                    <div class="category-card_content">
                                        <h3 class="category-card_title">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="category-card">
                                    <div class="category-card_icon">
                                        <img src="{{asset('public/assets/img/icon/cat-1_3.svg')}}" alt="image" />
                                    </div>
                                    <div class="category-card_content">
                                        <h3 class="category-card_title">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="category-card">
                                    <div class="category-card_icon">
                                        <img src="{{asset('public/assets/img/icon/cat-1_4.svg')}}" alt="image" />
                                    </div>
                                    <div class="category-card_content">
                                        <h3 class="category-card_title">
            ...
            <div class="row align-items-center">
                <div class="col-xl-6">
                    <div class="img-box1 mb-40 mb-xl-0">
                        <div class="img1">
                            <img class="tilt-active" src="{{asset('public/assets/img/normal/about_1_1.png')}}" alt="About" />
                        </div>
                        <div class="about-grid" data-bg-src="{{asset('public/assets/img/normal/about_1_3.png')}}">
                            <h3 class="about-grid_year">
                                <span class="counter-number">10</span>k<span class="text-theme">+</span>
                            </h3>
                            <p class="about-grid_text">Students Active Our Courses</p>
                        </div>
                        <div class="img2">
                            <img class="tilt-active" src="{{asset('public/assets/img/normal/about_1_2.png')}}" alt="About" />
                        </div>
                        <div class="shape-mockup about-shape1 jump" data-left="-67px" data-bottom="0">
                            <img src="{{asset('public/assets/img/normal/about_1_shape1.png')}}" alt="img" />
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-auto">
                            <div class="about-grid_img mb-30 mb-md-0">
                                <img src="{{asset('public/assets/img/normal/about_1_4.png')}}" alt="img" />
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="checklist">
    ...
    <section class="space" data-bg-src="{{asset('public/assets/img/bg/course_bg_1.png')}}" id="course-sec">
        <div class="container">
            ...
            <div class="row slider-shadow th-carousel course-slider-1" data-slide-show="4" data-ml-slide-show="3"
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="course-box">
                        <div class="course-img">
                            <img src="{{asset('public/assets/img/course/course_1_1.png')}}" alt="img" />
                        ...
                        <div class="course-content">
                            ...
                            <div class="course-author">
                                <div class="author-info">
                                    <img src="{{asset('public/assets/img/course/author.png')}}" alt="author" />
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="course-box">
                        <div class="course-img">
                            <img src="{{asset('public/assets/img/course/course_1_2.png')}}" alt="img" />
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="course-box">
                        <div class="course-img">
                            <img src="{{asset('public/assets/img/course/course_1_3.png')}}" alt="img" />
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="course-box">
                        <div class="course-img">
                            <img src="{{asset('public/assets/img/course/course_1_4.png')}}" alt="img" />
                            <span class="tag"><i class="fas fa-clock"></i> 02 WEEKS</span>
                        </div>
                        <div class="course-content">
                            <div class="course-rating">
    ...
    <div class="cta-area-1" data-bg-src="{{asset('public/assets/img/bg/cta-bg1.png')}}">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-8">
                    <div class="cta-wrap title-area mb-0">
                        <div class="cta-icon">
                            <img src="{{asset('public/assets/img/normal/cta-icon1.png')}}" alt="icon" />
                        </div>
        ...
        <div class="cta-img-1" data-overlay="title" data-opacity="8">
            <img src="{{asset('public/assets/img/normal/cta_1_1.png')}}" alt="Image" />
    ...
    <div class="why-area-1 space overflow-hidden">
        ...
        <div class="shape-mockup why-shape-2" data-bg-src="{{asset('public/assets/img/normal/wcu_1_shape1.png')}}"></div>
        <div class="shape-mockup why-shape-3 jump-reverse" data-bottom="25%" data-right="-3%">
            <img src="{{asset('public/assets/img/normal/wcu_1_shape2.png')}}" alt="img" />
        </div>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6">
                    <div class="wcu-img-1">
                        <div class="img1">
                            <img src="{{asset('public/assets/img/normal/wcu_1_1.png')}}" alt="img" />
                        </div>
                        <div class="student-count jump-reverse">
                            <h5 class="title">
                                <span class="text-theme"><span class="counter-number">10</span>k+</span>
                                Active Students
                            </h5>
                            <img src="{{asset('public/assets/img/normal/student-group_1_1.png')}}" alt="img" />
                        </div>
                        <div class="text-end">
                    ...
                    <div class="wcu-wrap1">
                        <div class="title-area mb-25">
                            ...
                            <p class="sec-text mt-20">
                                ...
                                markets with plug-and-play materials professionally seize
    ...
    <div class="container">
        <div class="counter-area-1 bg-theme" data-bg-src="{{asset('public/assets/img/bg/counter-bg_1.png')}}">
            <div class="row justify-content-between">
                <div class="col-sm-6 col-xl-3 counter-card-wrap">
                    <div class="counter-card">
                        <h2 class="counter-card_number">
                            <span class="counter-number">3.9</span>k<span class="fw-normal">+</span>
                        </h2>
                ...
                <div class="col-sm-6 col-xl-3 counter-card-wrap">
                    <div class="counter-card">
                        <h2 class="counter-card_number">
                            <span class="counter-number">15.8</span>k<span class="fw-normal">+</span>
                        </h2>
                        <p class="counter-card_text">
                ...
                <div class="col-sm-6 col-xl-3 counter-card-wrap">
                    <div class="counter-card">
                        <h2 class="counter-card_number">
                            <span class="counter-number">97.5</span>k<span class="fw-normal">+</span>
                        </h2>
                        <p class="counter-card_text">
                ...
                <div class="col-sm-6 col-xl-3 counter-card-wrap">
                    <div class="counter-card">
                        <h2 class="counter-card_number">
                            <span class="counter-number">100.2</span>k<span class="fw-normal">+</span>
                        </h2>
                        <p class="counter-card_text">
    ...
    <section class="cta-area-2 position-relative space-bottom">
        <div class="cta-bg-img" data-bg-src="{{asset('public/assets/img/bg/cta-bg2.png')}}"></div>
        <div class="cta-bg-img2" data-bg-src="{{asset('public/assets/img/bg/cta-bg2-shape.png')}}"></div>
        <div class="shape-mockup cta-shape1 jump d-md-block d-none" data-left="-2%" data-bottom="-7%">
            <img src="{{asset('public/assets/img/normal/cta_2_shape1.png')}}" alt="img" />
        </div>
        <div class="shape-mockup cta-shape2 jump-reverse d-md-block d-none" data-right="-1%" data-top="-3%">
            <img src="{{asset('public/assets/img/normal/cta_2_shape2.png')}}" alt="img" />
        </div>
        <div class="shape-mockup cta-shape3 spin d-md-block d-none" data-right="20%" data-top="30%">
            <img src="{{asset('public/assets/img/normal/cta_2_shape3.png')}}" alt="img" />
        </div>
        <div class="container text-center">
            <div class="cta-wrap2">
                <div class="title-area text-center mb-35">
                    <span class="sub-title"><i class="fal fa-book me-2"></i>Are You Ready For This
                        Offer</span>
                    <h2 class="sec-title text-white">
                        40% Offer First <span class="text-theme2">100 Student’s</span> For
                        Featured<br /><span class="fw-normal">Topics by Education Category</span>
                    </h2>
                    <p class="cta-text">
                        Get unlimited access to 6,000+ of Udemy’s top courses for your
                        team. Learn and improve skills across business, tec, design, and
                        more.
                    </p>
                </div>
    ...
    <div class="team-area overflow-hidden space" id="team-sec">
        <div class="shape-mockup team-bg-shape1 jump-reverse d-xxl-block d-none" data-left="-2%" data-top="0">
            <img src="{{asset('public/assets/img/team/team-shape_1_1.png')}}" alt="img" />
        </div>
        <div class="shape-mockup team-bg-shape2 jump d-xxl-block d-none" data-left="40%" data-top="20%">
            <img src="{{asset('public/assets/img/team/team-shape_1_2.png')}}" alt="img" />
        </div>
        <div class="shape-mockup team-bg-shape3 jump" data-left="5%" data-bottom="9%">
            <img src="{{asset('public/assets/img/team/team-shape_1_3.png')}}" alt="img" />
        </div>
        <div class="shape-mockup team-bg-shape4 spin" data-left="40%" data-bottom="20%">
            <img src="{{asset('public/assets/img/team/team-shape_1_4.png')}}" alt="img" />
        </div>
        <div class="shape-mockup team-bg-shape5 jump d-lg-block d-none" data-right="-7%" data-top="10%">
            <img src="{{asset('public/assets/img/team/team-shape_1_5.png')}}" alt="img" />
        </div>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 mb-40 mb-xl-0">
                    <div class="title-area mb-30">
                        ...
                        <p class="sec-text mt-20">
                            Graduates of XYZ University have achieved remarkable success in
                            their chosen fields, with many going on to pursue advanced
                            degrees, secure fulfilling careers, and make valuable
                            contributions to their communities.
                        </p>
                        <p class="sec-text">
                            The university takes pride in its alumni network, which serves
                            as a testament to the quality of education and the opportunities
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="team-card team-card-1-1 team-card-1-1-active mt-0">
                        <div class="team-img-wrap">
                            <div class="team-img">
                                <img src="{{asset('public/assets/img/team/team_1_1.jpg')}}" alt="Team" />
                            </div>
                        </div>
                    ...
                    <div class="team-card team-card-1-1">
                        <div class="team-img-wrap">
                            <div class="team-img">
                                <img src="{{asset('public/assets/img/team/team_1_2.jpg')}}" alt="Team" />
                            </div>
                        </div>
                        <div class="team-hover-wrap">
                            <div class="team-social">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="team-card team-card-1-2 mt-md-0">
                        <div class="team-img-wrap">
                            <div class="team-img">
                                <img src="{{asset('public/assets/img/team/team_1_3.jpg')}}" alt="Team" />
                            </div>
                        </div>
                        <div class="team-hover-wrap">
                            <div class="team-social">
                    ...
                    <div class="team-card team-card-1-2 team-card-1-2-active">
                        <div class="team-img-wrap">
                            <div class="team-img">
                                <img src="{{asset('public/assets/img/team/team_1_4.jpg')}}" alt="Team" />
                            </div>
                        </div>
                        <div class="team-hover-wrap">
                            <div class="team-social">
    ...
    <section class="space" data-bg-src="{{asset('public/assets/img/bg/event-bg_1.png')}}">
            ...
            <div class="row slider-shadow event-slider-1 th-carousel gx-70" data-slide-show="3" data-lg-slide-show="3"
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="event-card">
                        <div class="event-card_img" data-mask-src="{{asset('public/assets/img/event/event_img-shape.png')}}">
                            <img src="{{asset('public/assets/img/event/event_img-1.png')}}" alt="event" />
                        </div>
                        <div class="event-card_content">
                            <div class="event-author">
                                <div class="avater">
                                    <img src="{{asset('public/assets/img/event/event-author1.png')}}" alt="avater" />
                                </div>
                                <div class="details">
                            ...
                            <div class="event-card-shape jump">
                                <img src="{{asset('public/assets/img/event/event-box-shape1.png')}}" alt="img" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xl-4">
                    <div class="event-card">
                        <div class="event-card_img" data-mask-src="{{asset('public/assets/img/event/event_img-shape.png')}}">
                            <img src="{{asset('public/assets/img/event/event_img-2.png')}}" alt="event" />
                        </div>
                        <div class="event-card_content">
                            <div class="event-author">
                                <div class="avater">
                                    <img src="{{asset('public/assets/img/event/event-author2.png')}}" alt="avater" />
                                </div>
                                <div class="details">
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="event-card">
                        <div class="event-card_img" data-mask-src="{{asset('public/assets/img/event/event_img-shape.png')}}">
                            <img src="{{asset('public/assets/img/event/event_img-3.png')}}" alt="event" />
                        </div>
                        <div class="event-card_content">
                            <div class="event-author">
                                <div class="avater">
                                    <img src="{{asset('public/assets/img/event/event-author3.png')}}" alt="avater" />
                                </div>
                                <div class="details">
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="event-card">
                        <div class="event-card_img" data-mask-src="{{asset('public/assets/img/event/event_img-shape.png')}}">
                            <img src="{{asset('public/assets/img/event/event_img-4.png')}}" alt="event" />
                        </div>
                        <div class="event-card_content">
                            <div class="event-author">
                                <div class="avater">
                                    <img src="{{asset('public/assets/img/event/event-author4.png')}}" alt="avater" />
                                </div>
                                <div class="details">
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="event-card">
                        <div class="event-card_img" data-mask-src="{{asset('public/assets/img/event/event_img-shape.png')}}">
                            <img src="{{asset('public/assets/img/event/event_img-5.png')}}" alt="event" />
                        </div>
                        <div class="event-card_content">
                            <div class="event-author">
                                <div class="avater">
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="event-card">
                        <div class="event-card_img" data-mask-src="{{asset('public/assets/img/event/event_img-shape.png')}}">
                            <img src="{{asset('public/assets/img/event/event_img-6.png')}}" alt="event" />
                        </div>
                        <div class="event-card_content">
                            <div class="event-author">
                                <div class="avater">
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="event-card">
                        <div class="event-card_img" data-mask-src="{{asset('public/assets/img/event/event_img-shape.png')}}">
                            <img src="{{asset('public/assets/img/event/event_img-7.png')}}" alt="event" />
                        </div>
                        <div class="event-card_content">
                            <div class="event-author">
                                <div class="avater">
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="event-card">
                        <div class="event-card_img" data-mask-src="{{asset('public/assets/img/event/event_img-shape.png')}}">
                            <img src="{{asset('public/assets/img/event/event_img-8.png')}}" alt="event" />
                        </div>
                        <div class="event-card_content">
                            <div class="event-author">
                                <div class="avater">
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="event-card">
                        <div class="event-card_img" data-mask-src="{{asset('public/assets/img/event/event_img-shape.png')}}">
                            <img src="{{asset('public/assets/img/event/event_img-9.png')}}" alt="event" />
                        </div>
                        <div class="event-card_content">
                            <div class="event-author">
                                <div class="avater">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="title-area mb-lg-0 text-lg-start text-center">
                        ...
                        <h2 class="sec-title mb-0">
                            We Have More Than
                            <span class="text-theme"><span class="counter-number">4263</span>+</span>
                            Global Partners
                        </h2>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="client-wrap text-lg-end text-center">
                        <div class="row gy-40">
                            <div class="col-3">
                                <a href="blog.html" class="client-thumb"><img src="{{asset('public/assets/img/client/cilent_1_1.png')}}"
                                        alt="img" /></a>
                            </div>
                            <div class="col-3">
                                <a href="blog.html" class="client-thumb"><img src="{{asset('public/assets/img/client/cilent_1_2.png')}}"
                                        alt="img" /></a>
                            </div>
                            <div class="col-3">
                                <a href="blog.html" class="client-thumb"><img src="{{asset('public/assets/img/client/cilent_1_3.png')}}"
                                        alt="img" /></a>
                            </div>
                            <div class="col-3">
                                <a href="blog.html" class="client-thumb"><img src="{{asset('public/assets/img/client/cilent_1_4.png')}}"
                                        alt="img" /></a>
                            </div>
                            <div class="col-3">
                                <a href="blog.html" class="client-thumb"><img src="{{asset('public/assets/img/client/cilent_1_5.png')}}"
                                        alt="img" /></a>
                            </div>
                            <div class="col-3">
                                <a href="blog.html" class="client-thumb"><img src="{{asset('public/assets/img/client/cilent_1_6.png')}}"
                                        alt="img" /></a>
                            </div>
                            <div class="col-3">
                                <a href="blog.html" class="client-thumb"><img src="{{asset('public/assets/img/client/cilent_1_7.png')}}"
                                        alt="img" /></a>
                            </div>
                            <div class="col-3">
                                <a href="blog.html" class="client-thumb"><img src="{{asset('public/assets/img/client/cilent_1_8.png')}}"
                                        alt="img" /></a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-30 mb-lg-0">
                    <div class="cta-card" data-bg-src="{{asset('public/assets/img/bg/cta-bg_3_1.png')}}">
                ...
                <div class="col-lg-6">
                    <div class="cta-card" data-bg-src="{{asset('public/assets/img/bg/cta-bg_3_2.png')}}">
                        <div class="title-area mb-40">
                            <span class="sub-title text-white"><i class="fal fa-book me-2"></i>Popular Courses</span>
                            <h4 class="sec-title text-white">
    ...
    <section class="testi-area-1 overflow-hidden space-bottom" data-bg-src="{{asset('public/assets/img/bg/testi_bg_1.png')}}">
        <div class="shape-mockup testi-bg-shape1 jump" data-right="0" data-top="50%">
            <img src="{{asset('public/assets/img/testimonial/testi-bg-shape_1_1.png')}}" alt="img" />
        </div>
        <div class="shape-mockup testi-bg-shape2 spin" data-left="0" data-top="15%">
            <img src="{{asset('public/assets/img/testimonial/testi-bg-shape_1_2.png')}}" alt="img" />
        </div>
        <div class="container">
                    ...
                    <div class="th-carousel testi-slider1 dot-style2 row" id="testimonial-slider1" data-slide-show="2"
                            ...
                            <div class="testi-box">
                                ...
                                <div class="testi-box_content">
                                    <div class="testi-box_img">
                                        <img src="{{asset('public/assets/img/testimonial/testi_1_1.jpg')}}" alt="Avater" />
                                    </div>
                                    <p class="testi-box_text">
                                        “Quickly maximize visionary solutions after mission
                                        critical action items productivate premium portals for
                                        impactful -services stinctively negotiate enabled niche
                                ...
                                <div class="testi-box_bottom">
                                    ...
                                    <div class="testi-box_review">
                                        ...
                                        <i class="fa-solid fa-star-sharp"></i>
                                        <i class="fa-solid fa-star-sharp"></i>
                                        <i class="fa-solid fa-star-sharp"></i> (4.7)
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="testi-box">
                                ...
                                <div class="testi-box_content">
                                    <div class="testi-box_img">
                                        <img src="{{asset('public/assets/img/testimonial/testi_1_2.jpg')}}" alt="Avater" />
                                    </div>
                                    <p class="testi-box_text">
                                        “Quickly maximize visionary solutions after mission
                                        critical action items productivate premium portals for
            ...
            <div class="row slider-shadow th-carousel blog-slider-1" data-slide-show="3" data-lg-slide-show="2"
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="th-blog blog-single style2">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="{{asset('public/assets/img/blog/blog-1-1.jpg')}}" alt="Blog Image" /></a>
                        </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="th-blog blog-single style2">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="{{asset('public/assets/img/blog/blog-1-2.jpg')}}" alt="Blog Image" /></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="blog.html"><i class="fa-light fa-user"></i>by David Smith</a>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="th-blog blog-single style2">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="{{asset('public/assets/img/blog/blog-1-3.jpg')}}" alt="Blog Image" /></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="blog.html"><i class="fa-light fa-user"></i>by David Smith</a>
                            ...
                            <h4 class="box-title">
                                <a href="blog-details.html">University class starting soon while the lovely valley team
                                    work</a>
                            </h4>
                            <a href="blog-details.html" class="link-btn">Read More Details<i
                                    class="fas fa-arrow-right ms-2"></i></a>
    ...
    <footer class="footer-wrapper footer-layout1" data-bg-src="{{asset('public/assets/img/bg/footer-bg.png')}}">
        <div class="shape-mockup footer-shape1 jump" data-left="60px" data-top="70px">
            <img src="{{asset('public/assets/img/normal/footer-bg-shape1.png')}}" alt="img" />
        </div>
        <div class="shape-mockup footer-shape2 jump-reverse" data-right="80px" data-bottom="120px">
            <img src="{{asset('public/assets/img/normal/footer-bg-shape2.png')}}" alt="img" />
        </div>
        ...
        <div class="footer-wrap" data-bg-src="{{asset('public/assets/img/bg/jiji.png')}}">
                            ...
                            <div class="widget footer-widget">
                                <div class="th-widget-about">
                                    <div class="about-logo">
                                        <a href="index.html"><img src="{{asset('public/assets/img/logo-white.svg')}}" alt="Edura" /></a>
                                    </div>
                                    <p class="about-text">
